...
def main(args):
    ...
    for step in range(args.iterations):
        ...
        if (step + 1) % args.test_interval == 0:
            save_model(gloabl_model, save_dir, 'latest')
...
def init_loader():
    ...
    return dataset_srcs, dataset_vals, dataset_tgts, num_classes
